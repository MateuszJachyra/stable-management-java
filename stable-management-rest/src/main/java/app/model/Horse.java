...
public class Horse implements Comparable<Horse> {
    ...
    public Horse(String name, String breed, HorseType type, HorseStatus status,
    ...
    public String toString() {
        return "ID: "+id+", Name: "+name+", Breed: "+breed+", Type: "+type+", Status: "+status
                +", Age: "+age+", Price: "+price+", Weight: "+weight+", AvgRating: "+getAverageRating();
    }
